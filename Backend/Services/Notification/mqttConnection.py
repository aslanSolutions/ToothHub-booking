...
def on_connect(client, userdata, rc):
    if rc == 0:
        ...
        client.subscribe("topic/1") #should change the actuall topic name from the middleware
    else:
...
# Creating and Connection the client instance to the broker address and port
